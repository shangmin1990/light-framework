package com.le.bigdata.core.convertor;
...
import com.le.bigdata.core.convertor.filter.impl.PortraitDataFilter;
import com.le.bigdata.core.convertor.provider.DataProvider;
...
public class DataProcessorAspect {
    ...
    @Pointcut(value = "(@within(org.springframework.stereotype.Controller) " +
            ...
            "&& @annotation(com.le.bigdata.core.convertor.DataProcessor)")
